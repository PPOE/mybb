...
$l['mcp_nav_banning'] = "Moderation";
$l['mcp_nav_warninglogs'] = "Warnungs-Protokoll";
$l['mcp_nav_ipsearch'] = "IP-Suche";
$l['mcp_nav_editing_ban'] = "Eine Moderation bearbeiten";
$l['mcp_nav_ban_user'] = "Einen Benutzer unter Moderation stellen";
...
$l['bans_ending_soon'] = "Moderationen, die in Kürze enden";
...
$l['ban_error'] = "Fehler";
$l['ban_banned'] = "Benutzer unter Moderation";
$l['ban_user'] = "Einen Benutzer unter Moderation stellen";
$l['reason'] = "Grund";
...
$l['ban_bannedby'] = "Unter Moderation gestellt von";
$l['ban_movegroup'] = "Zur unter Moderation stehenden Benutzergruppe hinzufügen:";
$l['ban_liftafter'] = "Moderation aufheben nach:";
$l['no_banned'] = "Momentan gibt es keine Benutzer unter Moderation.";
$l['redirect_banuser'] = "Der Benutzer wurde erfolgreich unter Moderation gestellt.";
$l['redirect_banuser_updated'] = "Die Moderation des Benutzers wurde erfolgreich aktualisiert.";
...
$l['error_useralreadybanned'] = "Dieser Benutzer ist bereits unter Moderation. Du kannst einen Benutzer nur ein mal unter Moderation stellen.";
$l['error_cannotbanuser'] = "Du kannst diesen Benutzer nicht unter Moderation stellen, weil er höhere Rechte hat, als du selbst. Bitte kontaktiere den Administrator, wenn du diesen Benutzer unter Moderation stellen möchtest.";
$l['error_cannotbanself'] = "Du kannst dich nicht selbst unter Moderation stellen. Bitte gib einen anderen Benutzernamen ein.";
$l['error_no_perm_to_ban'] = "Du hast keine Berechtigungen diesen Benutzer zu sperren.";
$l['error_nobanreason'] = "Du hast keinen Grund für diese Moderation eingegeben. Bitte gib einen gültigen Grund ein.";
$l['error_nobangroup'] = "Du hast keine gültige Benutzergruppe eingegeben, in die der Benutzer verschoben werden kann.";
$l['edit_ban'] = "Moderation editieren";
$l['lift_ban'] = "Moderation aufheben";
$l['ban'] = "Moderation";
$l['error_invalidban'] = "Du hast eine ungültige Moderation eingegeben.";
$l['redirect_banlifted'] = "Die Moderation wurde erfolgreich aufgehoben.";
