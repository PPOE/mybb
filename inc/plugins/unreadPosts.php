...
class unreadPosts
{
    ...
    public function __construct()
    {
        ...
        $plugins->hooks["global_start"][10]["up_addHooks"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->addHooks();'));
    }
    ...
    public function addHooks()
    {
        ...
        $plugins->hooks["member_do_register_end"][10]["up_updateLastmark"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->updateLastmark();'));
        $plugins->hooks["misc_markread_end"][10]["up_updateLastmark"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->updateLastmark();'));
        $plugins->hooks["pre_output_page"][10]["up_pluginThanks"] = array("function" => create_function('&$arg', 'global $plugins; $plugins->objects[\'unreadPosts\']->pluginThanks($arg);'));
        ...
        if ($mybb->user['uid'] > 0)
        {
            ...
            $plugins->hooks["newreply_do_newreply_end"][10]["up_newThreadOrReplyMark"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->newThreadOrReplyMark();'));
            $plugins->hooks["newthread_do_newthread_end"][10]["up_newThreadOrReplyMark"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->newThreadOrReplyMark();'));
    
            $plugins->hooks["global_end"][10]["up_actionNewpost"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->actionNewpost();'));
            $plugins->hooks["pre_output_page"][10]["up_modifyOutput"] = array("function" => create_function('&$arg', 'global $plugins; $plugins->objects[\'unreadPosts\']->modifyOutput($arg);'));
            $plugins->hooks["search_start"][10]["up_doSearch"] = array("function" => create_function('', 'global $plugins; $plugins->objects[\'unreadPosts\']->doSearch();'));
        }
    }
    ...
    public function modifyOutput(&$content)
    {
        ...
        $sql = "SELECT COUNT(p.pid) as num_unread
                ...
                WHERE p.visible = 1 
                  AND {$this->where}
                  AND ((tr.dateline NOTNULL AND p.dateline > tr.dateline) OR p.dateline > {$mybb->user['lastmark']})
                  AND ((fr.dateline NOTNULL AND p.dateline > fr.dateline) OR p.dateline > {$mybb->user['lastmark']})
