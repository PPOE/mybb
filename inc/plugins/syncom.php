...
if (array_key_exists('syncom_newsgroup', $mybb->input) and ($mybb->input['fid'] != '')) {
	$sql_array = array("syncom_newsgroup" => $mybb->input['syncom_newsgroup'],
				"syncom_threadsvisible" => $mybb->input['syncom_threadsvisible'] ? 'true' : 'false',
				"syncom_html" => $mybb->input['syncom_html'] ? 'true' : 'false');
...
if (($mybb->input['module'] == 'forum-management') and (($mybb->input['action'] == 'edit') or ($mybb->input['action'] == 'add'))
	...
	if ($forum["syncom_threadsvisible"] == 't')
		$visiblechecked = ' checked="checked"';
	if ($forum["syncom_html"] == 't')
...
'</tr><td class="first">Synceinstellungen
 <div class="form_row">
<div class="forum_settings_bit"><label for="syncom_threadsvisible"><input type="checkbox" name="syncom_threadsvisible" value="true" class="checkbox_input" id="syncom_threadsvisible"'.$visiblechecked.'/>Nur Threadtitel sichtbar<br /></div>
<div class="forum_settings_bit"><label for="syncom_html"><input type="checkbox" name="syncom_html" value="true" class="checkbox_input" id="syncom_html"'.$htmlchecked.'/>Forenbeitr&auml;ge als HTML posten<br /></div>
</div> 
 </td></tr>';
}
}
