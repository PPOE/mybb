...
function tapatalk_install()
{
    ...
    {
        $db->query("
            CREATE TABLE " . TABLE_PREFIX . "tapatalk_users (  userid integer NOT NULL,  announcement smallint NOT NULL DEFAULT '1',  pm smallint NOT NULL DEFAULT '1',  subscribe smallint NOT NULL DEFAULT '1',  updated timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,  PRIMARY KEY (userid)  );
        ");
    }
